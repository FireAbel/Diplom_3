...
class MainPageLocators:
    ...
    CONSTRUCTOR_BURGER = (By.XPATH, '//div[contains(@class, "BurgerConstructor_basket__list")]')
    ...
    # Элементы конструктора
    BUN_IN_BURGER = (By.XPATH, ".//div[contains(@class, 'pos_top')]//span[contains(text(), 'Флюоресцентная булка R2-D3')]")
    ...
    INGREDIENT_DETAILS_CLOSE_BUTTON = (By.XPATH, ".//section[contains(@class, 'Modal_modal_open')]//button[contains(@class, 'close')]")
